...
class NativeZcam1C2paUtils : public jsi::HostObject {
  ...
  protected:
    ...
    jsi::Value cpp_uniffi_zcam1_c2pa_utils_fn_method_manifest_data_hash(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
    ...
    jsi::Value cpp_uniffi_zcam1_c2pa_utils_fn_constructor_manifesteditor_from_file_and_manifest(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
    ...
    jsi::Value cpp_uniffi_zcam1_c2pa_utils_fn_method_manifesteditor_add_action(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
    ...
    jsi::Value cpp_uniffi_zcam1_c2pa_utils_fn_func_verify_hash(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
    ...
    jsi::Value cpp_uniffi_zcam1_c2pa_utils_checksum_func_verify_hash(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
    ...
    jsi::Value cpp_uniffi_zcam1_c2pa_utils_checksum_method_manifest_data_hash(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
    ...
    jsi::Value cpp_uniffi_zcam1_c2pa_utils_checksum_method_manifesteditor_add_action(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
    ...
    jsi::Value cpp_uniffi_zcam1_c2pa_utils_checksum_constructor_manifesteditor_from_file_and_manifest(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
