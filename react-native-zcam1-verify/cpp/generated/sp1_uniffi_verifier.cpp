...
int8_t uniffi_sp1_uniffi_verifier_fn_func_verify_plonk(
    ...
    RustCallStatus *uniffi_out_err);
RustBuffer
ffi_sp1_uniffi_verifier_rustbuffer_alloc(uint64_t size,
                                         RustCallStatus *uniffi_out_err);
RustBuffer
ffi_sp1_uniffi_verifier_rustbuffer_from_bytes(ForeignBytes bytes,
                                              RustCallStatus *uniffi_out_err);
void ffi_sp1_uniffi_verifier_rustbuffer_free(RustBuffer buf,
                                             RustCallStatus *uniffi_out_err);
RustBuffer
ffi_sp1_uniffi_verifier_rustbuffer_reserve(RustBuffer buf, uint64_t additional,
                                           RustCallStatus *uniffi_out_err);
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::sp1_uniffi_verifier::Bridging<T>::fromJs(rt, callInvoker,
                                                              pointee);
    }
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_sp1_uniffi_verifier_rustbuffer_alloc(size, &status);
  }

  static void rustbuffer_free(RustBuffer buf) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    ffi_sp1_uniffi_verifier_rustbuffer_free(buf, &status);
  }

  static RustBuffer rustbuffer_from_bytes(ForeignBytes bytes) {
    RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
    return ffi_sp1_uniffi_verifier_rustbuffer_from_bytes(bytes, &status);
  }
...
// Callback function:
// uniffi::sp1_uniffi_verifier::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
// This method is called from the destructor of NativeSp1UniffiVerifier, which
...
// Callback function:
// uniffi::sp1_uniffi_verifier::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
static void cleanup() {
  ...
  // uniffi::sp1_uniffi_verifier::st::foreignfuture::foreignfuture::free
namespace uniffi::sp1_uniffi_verifier {
using namespace facebook;
using CallInvoker = uniffi_runtime::UniffiCallInvoker;
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::sp1_uniffi_verifier::st::foreignfuture::
...
template <> struct Bridging<UniffiForeignFutureStructU8> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.call_status =
        uniffi::sp1_uniffi_verifier::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::sp1_uniffi_verifier::Bridging<
...
template <> struct Bridging<UniffiForeignFutureStructRustBuffer> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.return_value =
        uniffi::sp1_uniffi_verifier::Bridging<RustBuffer>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "returnValue"));
    rsObject.call_status =
        uniffi::sp1_uniffi_verifier::Bridging<RustCallStatus>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "callStatus"));
...
template <> struct Bridging<UniffiRustFutureContinuationCallback> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
         const jsi::Value &value) {
    try {
      return uniffi::sp1_uniffi_verifier::cb::rustfuturecontinuationcallback::
...
NativeSp1UniffiVerifier::NativeSp1UniffiVerifier(
  ...
  props["ubrn_uniffi_sp1_uniffi_verifier_fn_func_verify_compressed"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_sp1_uniffi_verifier_fn_func_verify_compressed"),
          3,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_sp1_uniffi_verifier_fn_func_verify_compressed(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_sp1_uniffi_verifier_fn_func_verify_groth16"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_sp1_uniffi_verifier_fn_func_verify_groth16"),
          3,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_sp1_uniffi_verifier_fn_func_verify_groth16(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_sp1_uniffi_verifier_fn_func_verify_plonk"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_sp1_uniffi_verifier_fn_func_verify_plonk"),
          3,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_sp1_uniffi_verifier_fn_func_verify_plonk(
                rt, thisVal, args, count);
          });
  props["ubrn_uniffi_sp1_uniffi_verifier_checksum_func_verify_compressed"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "ubrn_uniffi_sp1_uniffi_verifier_"
                                        "checksum_func_verify_compressed"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_sp1_uniffi_verifier_checksum_func_verify_compressed(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_sp1_uniffi_verifier_checksum_func_verify_groth16"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "ubrn_uniffi_sp1_uniffi_verifier_checksum_func_verify_groth16"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_sp1_uniffi_verifier_checksum_func_verify_groth16(
                    rt, thisVal, args, count);
          });
  props["ubrn_uniffi_sp1_uniffi_verifier_checksum_func_verify_plonk"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_uniffi_sp1_uniffi_verifier_checksum_func_verify_plonk"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_sp1_uniffi_verifier_checksum_func_verify_plonk(
                    rt, thisVal, args, count);
          });
  props["ubrn_ffi_sp1_uniffi_verifier_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ubrn_ffi_sp1_uniffi_verifier_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_sp1_uniffi_verifier_uniffi_contract_version(
                rt, thisVal, args, count);
          });
}

void NativeSp1UniffiVerifier::registerModule(
...
jsi::Value NativeSp1UniffiVerifier::get(jsi::Runtime &rt,
...
NativeSp1UniffiVerifier::getPropertyNames(jsi::Runtime &rt) {
...
void NativeSp1UniffiVerifier::set(jsi::Runtime &rt, const jsi::PropNameID &name,
                                  const jsi::Value &value) {
...
jsi::Value
NativeSp1UniffiVerifier::cpp_uniffi_internal_fn_func_ffi__string_to_byte_length(
...
jsi::Value
NativeSp1UniffiVerifier::cpp_uniffi_internal_fn_func_ffi__string_to_arraybuffer(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value
NativeSp1UniffiVerifier::cpp_uniffi_internal_fn_func_ffi__arraybuffer_to_string(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
...
jsi::Value NativeSp1UniffiVerifier::
    cpp_uniffi_sp1_uniffi_verifier_fn_func_verify_compressed(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  RustCallStatus status =
      uniffi::sp1_uniffi_verifier::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_sp1_uniffi_verifier_fn_func_verify_compressed(
      uniffi::sp1_uniffi_verifier::Bridging<RustBuffer>::fromJs(rt, callInvoker,
                                                                args[0]),
      uniffi::sp1_uniffi_verifier::Bridging<RustBuffer>::fromJs(rt, callInvoker,
                                                                args[1]),
      uniffi::sp1_uniffi_verifier::Bridging<RustBuffer>::fromJs(rt, callInvoker,
                                                                args[2]),
      &status);
  uniffi::sp1_uniffi_verifier::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);

  return uniffi_jsi::Bridging<int8_t>::toJs(rt, callInvoker, value);
}
jsi::Value
NativeSp1UniffiVerifier::cpp_uniffi_sp1_uniffi_verifier_fn_func_verify_groth16(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::sp1_uniffi_verifier::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_sp1_uniffi_verifier_fn_func_verify_groth16(
      uniffi::sp1_uniffi_verifier::Bridging<RustBuffer>::fromJs(rt, callInvoker,
                                                                args[0]),
      uniffi::sp1_uniffi_verifier::Bridging<RustBuffer>::fromJs(rt, callInvoker,
                                                                args[1]),
...
jsi::Value
NativeSp1UniffiVerifier::cpp_uniffi_sp1_uniffi_verifier_fn_func_verify_plonk(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::sp1_uniffi_verifier::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_sp1_uniffi_verifier_fn_func_verify_plonk(
      uniffi::sp1_uniffi_verifier::Bridging<RustBuffer>::fromJs(rt, callInvoker,
                                                                args[0]),
      uniffi::sp1_uniffi_verifier::Bridging<RustBuffer>::fromJs(rt, callInvoker,
                                                                args[1]),
...
jsi::Value
NativeSp1UniffiVerifier::cpp_ffi_sp1_uniffi_verifier_uniffi_contract_version(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
