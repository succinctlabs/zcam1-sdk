...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_sp1_uniffi_verifier_fn_func_verify_compressed(
    proof: Uint8Array,
    publicInputs: Uint8Array,
    sp1VkHash: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): number;
  ubrn_uniffi_sp1_uniffi_verifier_fn_func_verify_groth16(
    proof: Uint8Array,
    publicInputs: Uint8Array,
    sp1VkHash: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): number;
  ubrn_uniffi_sp1_uniffi_verifier_fn_func_verify_plonk(
    proof: Uint8Array,
    publicInputs: Uint8Array,
    sp1VkHash: Uint8Array,
    uniffi_out_err: UniffiRustCallStatus,
  ): number;
  ubrn_uniffi_sp1_uniffi_verifier_checksum_func_verify_compressed(): number;
  ubrn_uniffi_sp1_uniffi_verifier_checksum_func_verify_groth16(): number;
  ubrn_uniffi_sp1_uniffi_verifier_checksum_func_verify_plonk(): number;
  ubrn_ffi_sp1_uniffi_verifier_uniffi_contract_version(): number;
}

// Casting globalThis to any allows us to look for `NativeSp1UniffiVerifier`
