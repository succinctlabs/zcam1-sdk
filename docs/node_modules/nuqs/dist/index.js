...
import { a as write, c as throttle, i as isAbsentFromUrl, n as globalThrottleQueue, o as debounce, r as createEmitter, s as defaultRateLimit, t as debounceController } from "./debounce-BI0MC054.js";
	...
	const update = useCallback((stateUpdater, callOptions = {}) => {
		...
		for (let [stateKey, value] of Object.entries(newState)) {
			...
			if (callOptions?.limitUrlUpdates?.method === "debounce" || limitUrlUpdates?.method === "debounce" || parser.limitUrlUpdates?.method === "debounce") {
				...
				const debouncedPromise = debounceController.push(update$1, timeMs, adapter, processUrlSearchParams);
