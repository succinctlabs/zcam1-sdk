...
- Files with `succinct.bindings` should be verified with [`verifyBindings()`](/sdk/verify-browser/verifyBindings)
- Files with `succinct.proof` should be verified with [`verifyProof()`](/sdk/verify-browser/verifyProof)
