...
- [`VerifiableFile.captureMetadata()`](/sdk/verify-browser/captureMetadata) - Returns capture metadata from the C2PA manifest
...
- [`VerifiableFile.authenticityStatus()`](/sdk/verify-browser/authenticityStatus) - Determines the file's authenticity status
