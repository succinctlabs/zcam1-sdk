...
Interface representing the active C2PA manifest extracted from a file. This is the underlying C2PA manifest object from the `@succinctlabs/react-native-zcam1-c2pa` package.
