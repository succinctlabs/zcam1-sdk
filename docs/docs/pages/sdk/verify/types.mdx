---
title: Verify Browser Types
description: Type definitions for the ZCAM1 Verify Browser SDK.
---
...
- [`VerifiableFile.captureMetadata()`](/sdk/verify/captureMetadata) - Returns capture metadata from the C2PA manifest
...
- [`VerifiableFile.authenticityStatus()`](/sdk/verify/authenticityStatus) - Determines the file's authenticity status
