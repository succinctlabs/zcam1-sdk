...
The Verify SDK (`@succinctlabs/react-native-zcam1-verify`) validates the authenticity of C2PA-signed photos with embedded proofs.
...
```tsx
import { CaptureMetadata } from "@succinctlabs/react-native-zcam1-verify";
...
- `parameters` - Device and camera settings:
  - `device_make`, `device_model`
  - `software_version`
  - `x_resolution`, `y_resolution`
  - `orientation`
  - `iso`, `exposure_time`
  - `focal_length`, `depth_of_field`
