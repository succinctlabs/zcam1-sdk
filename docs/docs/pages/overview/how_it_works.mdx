...
1. **Capture**: Take a photo and sign it with a hardware-backed key, attaching a verifiable attestation to the photo.
2. **Prove** (optional): Generate a zero-knowledge proof of the capture attestation.
...
See the [C2PA page](/overview/c2pa) for in-depth information on C2PA and how ZCAM uses C2PA.
