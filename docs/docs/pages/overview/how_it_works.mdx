...
ZCAM is built on three core technologies: Apple's App Attest service and Secure Enclave for hardware-backed signing, C2PA for embedding metadata, and SP1 for zero-knowledge proofs. 
