...
Authenticity proves the photo came from a real camera, but not necessarily that the *scene* was real. Someone could photograph a screen displaying an AI-generated image. The photo would be authentically captured, but the content would be misleading.
