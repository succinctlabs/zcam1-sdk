...
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Device Authenticity"}),": The photo was signed on a genuine device with a Secure Enclave"]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"App Binding"}),": The signing key is bound to a specific application (via Apple App Attest on iOS; Android Key Attestation + Google Play Integrity on Android, planned)"]}),`
...
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Proof Validity"}),": The above properties are verified in a zero-knowledge proof that chains to the platform root certificate"]}),`
`]}),`
...
`,e.jsxs(i.table,{children:[e.jsx(i.thead,{children:e.jsxs(i.tr,{children:[e.jsx(i.th,{children:"Assumption"}),e.jsx(i.th,{children:"Rationale"})]})}),e.jsxs(i.tbody,{children:[e.jsxs(i.tr,{children:[e.jsx(i.td,{children:"Secure Enclave keys cannot be exfiltrated"}),e.jsx(i.td,{children:"Hardware security guarantee from Apple / Android"})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:"Apple App Attest is honest"}),e.jsx(i.td,{children:"Apple signs attestations only for legitimate device/app pairs"})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:"Android Key Attestation + Play Integrity are honest"}),e.jsx(i.td,{children:"Google provides hardware-backed key and app integrity guarantees"})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:"SP1 proof system is sound"}),e.jsx(i.td,{children:"Groth16 proofs cannot be forged without the witness"})]})]})]}),`
...
`,e.jsxs(i.h3,{id:"gps-location-and-timestamp",children:["GPS Location and Timestamp",e.jsx(i.a,{"aria-hidden":"true",tabIndex:"-1",href:"#gps-location-and-timestamp",children:e.jsx(i.div,{"data-autolink-icon":!0})})]}),`
`,e.jsxs(i.p,{children:["GPS location and timestamp embedding are ",e.jsx(i.strong,{children:"opt-in"})," features enabled via the ",e.jsx(i.a,{href:"/sdk/capture/ZCamera#captureLocationEnabled",children:e.jsx(i.code,{children:"captureLocationEnabled"})})," and ",e.jsx(i.a,{href:"/sdk/capture/ZCamera#captureTimestampEnabled",children:e.jsx(i.code,{children:"captureTimestampEnabled"})})," props on ",e.jsx(i.code,{children:"ZCamera"}),". When enabled, the device queries GPS at capture time and embeds the coordinates and/or timestamp directly into the C2PA manifest."]}),`
`,e.jsx(i.p,{children:"Because these values come from GPS rather than the device clock or software, they are relatively hard to spoof:"}),`
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"GPS coordinates"})," require the device to have a genuine satellite fix or cell/Wi-Fi assisted location. Spoofing GPS at the OS level typically requires a jailbroken device, which is separately detected and flagged."]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"GPS timestamp"})," is derived from the GPS signal itself, not the device clock, making it independent of any user-controlled time setting."]}),`
`]}),`
`,e.jsxs(i.p,{children:["When location retrieval fails (e.g., permission denied, no GPS fix within the timeout), the manifest records ",e.jsx(i.code,{children:"isLocationAvailable: false"})," and a ",e.jsx(i.code,{children:"locationRetrievalStatus"}),' reason, so verifiers can distinguish "location not requested" from "location attempted but unavailable."']}),`
...
`,e.jsxs(i.table,{children:[e.jsx(i.thead,{children:e.jsxs(i.tr,{children:[e.jsx(i.th,{children:"Field"}),e.jsx(i.th,{children:"What It Measures"}),e.jsx(i.th,{children:"Fraud Indicator"})]})}),e.jsxs(i.tbody,{children:[e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"Subject Distance"})}),e.jsx(i.td,{children:"Distance to focused subject"}),e.jsx(i.td,{children:"Focus distance inconsistent with the subject of picture"})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"Depth Map"})}),e.jsx(i.td,{children:"Per-pixel depth from dual cameras/LiDAR"}),e.jsx(i.td,{children:"Flat depth when the subject has more depth variance"})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"White Balance"})}),e.jsx(i.td,{children:"Color temperature"}),e.jsx(i.td,{children:"Screen color temperature differs from natural light"})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"Ambient Light"})}),e.jsx(i.td,{children:"Environmental light level"}),e.jsx(i.td,{children:"Unusually uniform lighting could indicate screen glow"})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"GPS"})}),e.jsx(i.td,{children:"Location embedded from device GPS at capture time"}),e.jsx(i.td,{children:"Location inconsistent with claimed scene"})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"Timestamp"})}),e.jsx(i.td,{children:"GPS-sourced timestamp embedded at capture time"}),e.jsx(i.td,{children:"Timestamp inconsistent with lighting conditions or claimed context"})]})]})]})]})}function d(t={}){const{wrapper:i}={...s(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(n,{...t})}):n(t)}export{d as default,a as frontmatter};
