import{u as a,j as e}from"./index-B-z_mEuQ.js";const r={title:"Architecture",description:"undefined"};function n(t){const i={a:"a",aside:"aside",code:"code",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.header,{children:e.jsxs(i.h1,{id:"architecture",children:["Architecture",e.jsx(i.a,{"aria-hidden":"true",tabIndex:"-1",href:"#architecture",children:e.jsx(i.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(i.li,{children:"Generate and sign a valid C2PA manifest over the photo including bindings of a signature of a photo using a hardware-attested key and associated attestation."}),`
...
`,e.jsx(i.aside,{"data-callout":"info",children:e.jsx(i.p,{children:"A verifiable photo is defined as a photo that is guaranteed to have been captured on the device camera, using the SDK, and not tampered before it was signed."})}),`
...
`,e.jsxs(i.table,{children:[e.jsx(i.thead,{children:e.jsxs(i.tr,{children:[e.jsx(i.th,{children:"Key"}),e.jsx(i.th,{children:"Purpose"}),e.jsx(i.th,{children:"Attested"})]})}),e.jsxs(i.tbody,{children:[e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"Device Key"})}),e.jsx(i.td,{children:"Signs over a hash of the photo"}),e.jsx(i.td,{children:"Yes (App Attest on iOS; Android Key Attestation on Android)"})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:e.jsx(i.strong,{children:"Content Key"})}),e.jsx(i.td,{children:"Signs the C2PA manifest"}),e.jsx(i.td,{children:"No"})]})]})]}),`
`,e.jsx(i.p,{children:"Both keys live in the device's Secure Enclave. The device key is attested to have been generated on the Secure Enclave and is scoped to the specific app."}),`
...
`,e.jsxs(i.ol,{children:[`
`,e.jsx(i.li,{children:"The photo is hashed, then signed using the device key. This outputs a hardware-backed assertion including a signature over the hash."}),`
...
`,e.jsxs(i.li,{children:["A ",e.jsx(i.code,{children:"succinct.bindings"})," assertion is added to the manifest including data necessary to prove that the photo was signed using a valid hardware-attested key."]}),`
`]}),`
`,e.jsx(i.p,{children:e.jsx(i.img,{src:"/images/diagram_capture.png",alt:"Capture flow diagram"})}),`
`,e.jsxs(i.p,{children:[e.jsx(i.strong,{children:"Output:"})," A verifiable photo with a valid C2PA manifest containing metadata and an assertion that the photo was signed with a hardware-attested key."]}),`
...
`]})]})}function d(t={}){const{wrapper:i}={...a(),...t.components};return i?e.jsx(i,{...t,children:e.jsx(n,{...t})}):n(t)}export{d as default,r as frontmatter};
