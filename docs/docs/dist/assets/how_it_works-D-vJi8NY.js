import{f as a,j as e}from"./index-CTn8ORcW.js";const r={title:"How it Works",description:"undefined"};function i(n){const t={a:"a",aside:"aside",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",img:"img",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...a(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.header,{children:e.jsxs(t.h1,{id:"how-it-works",children:["How it Works",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#how-it-works",children:e.jsx(t.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(t.p,{children:"ZCAM is built on three core technologies: Apple's App Attest service and Secure Enclave for hardware-backed signing, C2PA for embedding metadata, and SP1 for zero-knowledge proofs."}),`
