import{u as a,j as e}from"./index-DYU0ST6z.js";const s={title:"C2PA",description:"undefined"};function i(t){const n={a:"a",aside:"aside",div:"div",em:"em",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...a(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(n.header,{children:e.jsxs(n.h1,{id:"c2pa",children:["C2PA",e.jsx(n.a,{"aria-hidden":"true",tabIndex:"-1",href:"#c2pa",children:e.jsx(n.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsx(n.p,{children:"C2PA was developed by a consortium including Adobe, Microsoft, Intel, and the BBC, among others. The standard enables any tool—cameras, editors, AI generators—to attach cryptographically signed metadata that travels with the content."}),`
