...
`,e.jsx(i.p,{children:"When a user wants to take a zphoto, the SDK opens the camera screen. After the photo is taken, the SDK embeds a valid C2PA manifest by doing the following:"}),`
`,e.jsxs(i.ol,{children:[`
...
`,e.jsxs(i.p,{children:[e.jsx(i.strong,{children:"Output:"})," The final zphoto with a valid C2PA manifest including a verifiable proof."]}),`
