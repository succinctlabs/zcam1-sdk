import{u as a,j as e}from"./index-B-z_mEuQ.js";const r={title:"Insurance Claim Verification",description:"undefined"};function t(n){const i={a:"a",code:"code",div:"div",h1:"h1",h3:"h3",header:"header",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...a(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.header,{children:e.jsxs(i.h1,{id:"insurance-claim-verification",children:["Insurance Claim Verification",e.jsx(i.a,{"aria-hidden":"true",tabIndex:"-1",href:"#insurance-claim-verification",children:e.jsx(i.div,{"data-autolink-icon":!0})})]})}),`
...
`]}),`
`]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Proof Generation"})," (Optional): Use ",e.jsx(i.code,{children:"@succinctlabs/react-native-zcam1/proving"})," to attach zero-knowledge proofs:",`
`,e.jsxs(i.ul,{children:[`
...
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:["Integrate ",e.jsx(i.code,{children:"@succinctlabs/react-native-zcam1"})," (or server-side equivalent) into the backend"]}),`
`,e.jsxs(i.li,{children:["For each photo, call ",e.jsx(i.code,{children:"verifyBindings()"})," or ",e.jsx(i.code,{children:"verifyProof()"})," to validate authenticity"]}),`
...
`]}),`
`]}),`
`]})]})}function l(n={}){const{wrapper:i}={...a(),...n.components};return i?e.jsx(i,{...n,children:e.jsx(t,{...n})}):t(n)}export{l as default,r as frontmatter};
