import{f as i,j as e}from"./index-DS39NnaK.js";const o={title:"Introduction",description:"undefined"};function n(r){const t={a:"a",div:"div",h1:"h1",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...i(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(t.header,{children:e.jsxs(t.h1,{id:"introduction",children:["Introduction",e.jsx(t.a,{"aria-hidden":"true",tabIndex:"-1",href:"#introduction",children:e.jsx(t.div,{"data-autolink-icon":!0})})]})}),`
...
`}),`
`,e.jsxs("div",{className:"doc-cards",children:[e.jsxs("a",{href:"/getting-started/installation",className:"doc-card",children:[e.jsx("h3",{children:"🚀 Getting Started"}),e.jsx("p",{children:e.jsx(t.p,{children:"Install the SDK and get up and running with your first zphoto in minutes."})})]}),e.jsxs("a",{href:"/sdk/capture",className:"doc-card",children:[e.jsx("h3",{children:"📱 Using the SDK"}),e.jsx("p",{children:e.jsx(t.p,{children:"Learn how to build apps with the ZCAM SDK."})})]}),e.jsxs("a",{href:"/c2pa-ecosystem/editing_zcam_photos",className:"doc-card",children:[e.jsx("h3",{children:"🔗 C2PA Compatibility"}),e.jsx("p",{children:e.jsx(t.p,{children:"Understand how ZCAM works with C2PA and editing tools in the ecosystem."})})]}),e.jsxs("a",{href:"/technical-docs/architecture",className:"doc-card",children:[e.jsx("h3",{children:"🔧 Technical Docs"}),e.jsx("p",{children:e.jsx(t.p,{children:"Deep dive into the ZCAM architecture, security, and FAQs."})})]})]})]})}function a(r={}){const{wrapper:t}={...i(),...r.components};return t?e.jsx(t,{...r,children:e.jsx(n,{...r})}):n(r)}export{a as default,o as frontmatter};
