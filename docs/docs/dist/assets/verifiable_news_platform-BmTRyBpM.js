import{u as r,j as e}from"./index-B-z_mEuQ.js";const a={title:"Verifiable News Platform",description:"undefined"};function t(n){const i={a:"a",code:"code",div:"div",h1:"h1",h2:"h2",h3:"h3",header:"header",li:"li",ol:"ol",p:"p",strong:"strong",ul:"ul",...r(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.header,{children:e.jsxs(i.h1,{id:"verifiable-news-platform",children:["Verifiable News Platform",e.jsx(i.a,{"aria-hidden":"true",tabIndex:"-1",href:"#verifiable-news-platform",children:e.jsx(i.div,{"data-autolink-icon":!0})})]})}),`
...
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Camera Setup"}),": Use ",e.jsx(i.code,{children:"@succinctlabs/react-native-zcam1"})," to initialize the camera:",`
`,e.jsxs(i.ul,{children:[`
...
`]}),`
`]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Proof Generation"})," (Optional): Use ",e.jsx(i.code,{children:"@succinctlabs/react-native-zcam1/proving"})," to generate zero-knowledge proofs:",`
`,e.jsxs(i.ul,{children:[`
...
`]}),`
`]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.strong,{children:"Client-Side Verification"}),": Integrate ",e.jsx(i.code,{children:"@succinctlabs/react-native-zcam1"})," (or web equivalent) to enable verification:",`
`,e.jsxs(i.ul,{children:[`
`,e.jsx(i.li,{children:'Add a "Verify Photo" button for each photo in articles'}),`
`,e.jsxs(i.li,{children:["Call ",e.jsx(i.code,{children:"verifyBindings()"})," or ",e.jsx(i.code,{children:"verifyProof()"})," to validate authenticity"]}),`
