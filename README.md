...
```
zcam1-sdk/
├─ [backend][1]/                    # Rust HTTP server and orchestration layer
...
├─ [react-native-zcam1-capture][2]/ # React Native Capture SDK (recording + secure storage)
├─ [react-native-zcam1-prove][3]/   # React Native Proving SDK (proof generation client)
├─ [react-native-zcam1-verify][4]/  # React Native Verify SDK (proof & C2PA verification)
...
[1]: backend/README.md
[2]: react-native-zcam1-capturey/README.md
[3]: react-native-zcam1-provey/README.md
[4]: react-native-zcam1-verify/README.md
