...
pub const GOOGLE_HARDWARE_ROOT_RSA: &str = r"-----BEGIN CERTIFICATE-----
...
pub const GOOGLE_HARDWARE_ROOT_EC: &str = r"-----BEGIN CERTIFICATE-----
...
pub const GOOGLE_SOFTWARE_ROOT: &str = r"-----BEGIN CERTIFICATE-----
